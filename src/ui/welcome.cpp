...
>>>>>>> new-architecture:src/ui/welcome.cpp
...
=======
    ...
    INSERT INTO users (
        login, password, name_0, name_1, name_2,
        role, tab_num, card_id, doz_tld_id, set_id, kas_id, mesh_id
    ) VALUES (
        :login, :password, :name_0, :name_1, :name_2,
        :role, :tab_num, :card_id, :doz_tld_id, :set_id, :kas_id, :mesh_id
    )
    ...
    // Именованная привязка (порядок не важен!)
    insertQuery.bindValue(":login", "admin");
    insertQuery.bindValue(":password", "admin");
    insertQuery.bindValue(":name_0", "Администратор");
    insertQuery.bindValue(":name_1", "Администратор");
    insertQuery.bindValue(":name_2", "Администратор");
    insertQuery.bindValue(":role", "admin");
    insertQuery.bindValue(":tab_num", 1);
    insertQuery.bindValue(":card_id", "admin_1");
    insertQuery.bindValue(":doz_tld_id", "admin_1");
    insertQuery.bindValue(":set_id", 1);
    insertQuery.bindValue(":kas_id", 1);
    insertQuery.bindValue(":mesh_id", 1);
>>>>>>> new-architecture:src/ui/welcome.cpp
